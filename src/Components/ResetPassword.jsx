...
function ResetPassword() {
  ...
  async function validateToken() {
    try {
      let res = await API.get("/user/getUsers");
  ...
  let resetSubmit = async (e) => {
    ...
    e.preventDefault();
    try {
      let res = await API.put("/user/resetPassword", {
        email,
        pass1,
        pass2,
      });
      ...
      console.log(error);
      toast.error(
        error.response.data || "Password and confirm password doesnt match"
      );
      setMessageColor("red");
      ...
      >
        ...
        <form className="col-md-3 col-xxl-5 form-box">
          <div className="mb-3" id="formBasicPassword1">
            <label htmlFor="password1" className="my-2 ms-1">
              Password
            </label>
            <input
              type="password"
          ...
          <div className="mb-3" id="formBasicPassword2">
            <label htmlFor="password2" className="my-2 ms-1">
              Confirm Password
            </label>
            <input
              type="password"
